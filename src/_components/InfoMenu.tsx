export default () => (
  <div class="infoMenu sticky-top">
    ...
    <ul class="d-flex flex-column">
      ...
      <li><a class="btn btn-outline-dark btn-shadow my-2" href="https://chaos.social/@chaos_fl">Mastodon @chaos_fl@chaos.social</a></li>
      <li><a class="btn btn-outline-dark btn-shadow my-2" href="https://twitter.com/chaos_fl">Twitter</a></li>
      <li><a class="btn btn-outline-dark btn-shadow my-2" href="https://www.instagram.com/chaos_fl/">Instagram</a></li>
      ...
      <li><a class="btn btn-outline-dark btn-shadow my-2" href="/feed.rss">RSS</a></li>
    </ul>
